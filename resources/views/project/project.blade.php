...
<div class="jumbotron jumbotron-fluid">
    <div class="container">
        ...
        <a class="btn btn-primary" href="{{ route('project.create') }}" role="button">Create New Post</a>
...
<!-- <button class="btn btn-primary" href="{{ route('project.create') }}">Create New Post</button> -->
